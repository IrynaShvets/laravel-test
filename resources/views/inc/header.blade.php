<header class="d-flex flex-column flex-md-row align-items-center p-3 bg-warning bg-gradient">
    ...
    <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('post') }}">Create post</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('post-data') }}">All posts</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('product') }}">Product</a>
        <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('product-data') }}">All product</a>
